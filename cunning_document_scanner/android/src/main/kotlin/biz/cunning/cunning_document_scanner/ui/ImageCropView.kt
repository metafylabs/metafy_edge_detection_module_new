package biz.cunning.cunning_document_scanner.ui
...
import biz.cunning.cunning_document_scanner.extensions.drawQuad
...
class ImageCropView(context: Context, attrs: AttributeSet) : AppCompatImageView(context, attrs) {
     ...
     */
    val corners: Quad
        get() = quad!!.mapPreviewToOriginalImageCoordinates(
        imagePreviewBounds,
        ratio
    )
